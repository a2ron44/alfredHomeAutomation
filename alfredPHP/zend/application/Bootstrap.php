...
class Bootstrap extends Zend_Application_Bootstrap_Bootstrap {
	...
	protected function _initAutoLoad() {
		 ...
		 */
		 ...
		 $fc->registerPlugin(new Plugin_RestHandler());
	...
	/**
	 * Needed for routing.
	 * Override for web services
	 */
	protected function _initRoutes() {
		
		// Generic Services Route - sets up access to ....url/services/[service name]
		$routes [] = new Zend_Controller_Router_Route ( 'services/:controller/:service/*', array (
				'module' => 'default',
				'action' => 'dispatch' 
		) );
		...
		$restRoute = new Zend_Rest_Route ( $front, array (), array ('module' =>
				'api',
		) );
	...
	/**
	 * Setup for modules.
	 * in example url call, [myUrl]/default/index/edit
