<?php
class Base_Db_Exception extends Zend_Db_Exception
{

	protected $_log;
	
	public function __construct($msg = '',$showTrace = false, $showRequest = false,$showUser = false, $level = 'warn', $code = 0, Exception $previous = null)
	{
		...
		$string .= 'MSG:' . $this->getMessage() . PHP_EOL  . PHP_EOL;
		if($showRequest){
		...
		Base_Log::$level($string, $showTrace, $showRequest);
